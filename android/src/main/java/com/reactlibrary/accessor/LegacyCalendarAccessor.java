package com.reactlibrary.accessor;
...
public class LegacyCalendarAccessor extends AbstractCalendarAccessor {
    ...
    public LegacyCalendarAccessor(ReactApplicationContext reactContext,
    ...
    protected Cursor queryAttendees(String[] projection, String selection,
        ...
        return this.currentActivity.managedQuery(Uri.parse(uri), projection,
